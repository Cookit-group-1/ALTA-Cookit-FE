...
const CardHistory: FC<myProps> = ({ title, titleBtn, route, transactionDetails, totalPrice}) => {
            ...
            <div className='bg-white pb-10 mb-5'>
                ...
                <div className='py-2 px-3'>
                    <div className='grid grid-cols-5 md:grid-cols-4 '>
                        ...
                        <div className='col-span-3 pl-5 relative  grid grid-cols-1 md:grid-cols-1 lg:grid-cols-4 md:gap-5'>
                            ...
                            <p className='text-orange-500 md:text-2xl lg:text-xl lg:font-semibold lg:mt-[20%]'>Rp{transactionDetails[0].price}</p>
                ...
                <div className='w-full h-16 px-5 grid grid-cols-2'>
                    ...
                    {route == 'toShip'
                        ...
                        : route == 'completed' ? <button className='w-44 col-start-2 bg-white place-self-end py-1 rounded-md text-black'>{titleBtn}</button>
                            : <button className='w-44 col-start-2 bg-primary place-self-end py-1 rounded-md text-white'>{titleBtn}</button>
                    }
                </div>
            </div>
        </>
