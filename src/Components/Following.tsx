    ...
    return (
        <>
            <div className='grid grid-cols-5 my-5 items-center'>
                ...
                <button onClick={handleUnfoll} className=' col-span-2 w-3/4 lg:w-1/2 place-self-end bg-white border-2 border-black rounded-md h-8 text-black'>Following</button>
            </div>
        </>
    )
}
