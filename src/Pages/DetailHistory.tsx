...
const DetailHostory = () => {
    ...
    return (
        <>
            ...
            <div className='px-5 py-5 grid grid-cols-1 lg:grid-cols-2 gap-5 bg-gray-100'>
                {/* payment */}
                <div className='bg-white  realtive px-3 py-2 rounded-md'>
                    ...
                    <div className=''>
                        <div className='grid  grid-cols-1 md:grid-cols-2 justify-between my-5 gap-4'>
                            ...
                            <p className='sm:mt-5'>Virtual Account Number</p>
                            <div className='text-start flex flex-row gap-2 items-center md:justify-end md:text-end -mt-4 md:mt-4 lg:mt-4 text-primary'>{dataTransaction.virtual_account_number} <span className='cursor-pointer' onClick={copyVa}><MdFileCopy /></span></div>
